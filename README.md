# Escape from Tarkov Auto Examine ![Stars](https://img.shields.io/github/stars/Avnsx/Escape-from-Tarkov-Auto-Examine?style=flat-square) ![Downloads](https://img.shields.io/github/downloads/Avnsx/Escape-from-Tarkov-Auto-Examine/total?color=violet&label=.exe%20downloads&link=https://github.com/Avnsx/Escape-from-Tarkov-Auto-Examine/releases&style=flat-square)
